...
public class SOSGameGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        RadioButtonGroup radioBox1 = new RadioButtonGroup("S", "O");
        radioBox1.setLayoutX(480);
        radioBox1.setLayoutY(250);

        RadioButtonGroup radioBox2 = new RadioButtonGroup("S", "O");
        radioBox2.setLayoutX(120);
        radioBox2.setLayoutY(250);
